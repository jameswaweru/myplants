class PlantedTree {
  ...
  PlantedTree(this.dayLastWatered, this.plantId , this.name, this.description, this.growZoneNumber,
      this.wateringInterval , this.imageUrl, this.wikipediaLink, this.datePlanted);
  ...
  factory PlantedTree.fromJson(dynamic json) {
    return PlantedTree(
        json['dayLastWatered'] as int,
...
// List<PlantedTree> trees = [
//   PlantedTree("malus-pumila", "Apple", "An apple is a sweet, edible fruit produced by an apple tree (Malus pumila). Apple trees are cultivated worldwide, "
